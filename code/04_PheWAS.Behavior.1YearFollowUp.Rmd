---
title: "04_PheWAS.Behavior.1YearFollowUp"
output:
  html_document:
    df_print: paged
---
...
## Filter data #
```{r}
abcdData_Y1Followup <- abcdData %>% filter(eventname == "1_year_follow_up_y_arm_1")
abcdData_Y1Followup %>% group_by(ethnicity) %>% tally() 

abcdData_Y1Followup_C4 <- abcdData_Y1Followup %>% filter(!is.na(c4a_total))
abcdData_Y1Followup_C4 %>% group_by(ethnicity) %>% tally() 

abcdData_Y1Followup_C4 <- abcdData_Y1Followup_C4 %>% filter(!is.na(pps_y_ss_number))
abcdData_Y1Followup_C4 %>% group_by(ethnicity) %>% tally() 

abcdData_Y1Followup_C4 <- abcdData_Y1Followup_C4 %>% filter(!is.na(pps_y_ss_severity_score))
abcdData_Y1Followup_C4 %>% group_by(ethnicity) %>% tally() 

abcdData_Y1Followup_C4 <- abcdData_Y1Followup_C4 %>% filter(!is.na(Psychosis_wPQ_susp))
abcdData_Y1Followup_C4 %>% group_by(ethnicity) %>% tally() 

abcdData_Y1Followup_C4_filtered <- abcdData_Y1Followup_C4 %>% filter(ethnicity %in% c("AFR", "AMR", "EUR"))
abcdData_Y1Followup_C4_filtered %>% group_by(ethnicity) %>% tally() 

abcdData_Y1Followup_C4_filtered <- abcdData_Y1Followup_C4_filtered %>%
  filter(c4_allele1_structure %in% c("AL","AL-AL","AL-BL", "AL-BS", "BS"))
abcdData_Y1Followup_C4_filtered <- abcdData_Y1Followup_C4_filtered %>%
  filter(c4_allele2_structure %in% c("AL","AL-AL","AL-BL", "AL-BS", "BS"))

abcdData_Y1Followup_C4_filtered %>% group_by(rel_family_id) %>% tally() %>% arrange(desc(n))  
```
...
```{r}
abcdData_Y1Followup_C4_filtered <- 
  abcdData_Y1Followup_C4_filtered %>% 
  mutate(pds_p_ss_all_category_2 = coalesce(pds_p_ss_male_category_2, pds_p_ss_female_category_2)) 
abcdData_Y1Followup_C4_filtered$pds_p_ss_all_category_2 <- as.numeric(abcdData_Y1Followup_C4_filtered$pds_p_ss_all_category_2)
```

## Add 1 to gamma log-link variables that start at 0  #
```{r}
abcdData_Y1Followup_C4_filtered$bis_y_ss_bas_rr_plus1 <- abcdData_Y1Followup_C4_filtered$bis_y_ss_bas_rr + 1
abcdData_Y1Followup_C4_filtered$bis_y_ss_bas_drive_plus1 <- abcdData_Y1Followup_C4_filtered$bis_y_ss_bas_drive + 1
abcdData_Y1Followup_C4_filtered$pgbi_p_ss_score_plus1 <- abcdData_Y1Followup_C4_filtered$pgbi_p_ss_score + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_4b_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_4b_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_5b_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_5b_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6a_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6a_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6b_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6b_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6c_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6c_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6d_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6d_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6e_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6e_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6f_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6f_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6g_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6g_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6h_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6h_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6i_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6i_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6j_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6j_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6k_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6k_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6l_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6l_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6m_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6m_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6n_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6n_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6o_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6o_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6p_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6p_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6q_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6q_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6r_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6r_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_6s_times_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_6s_times_p + 1
abcdData_Y1Followup_C4_filtered$medhx_ss_9b_p_plus1 <- abcdData_Y1Followup_C4_filtered$medhx_ss_9b_p + 1
abcdData_Y1Followup_C4_filtered$devhx_16_p_plus1 <- abcdData_Y1Followup_C4_filtered$devhx_16_p + 1
abcdData_Y1Followup_C4_filtered$bis_y_ss_basm_rr_plus1 <- abcdData_Y1Followup_C4_filtered$bis_y_ss_basm_rr + 1
abcdData_Y1Followup_C4_filtered$bis_y_ss_basm_drive_plus1 <- abcdData_Y1Followup_C4_filtered$bis_y_ss_basm_drive + 1
abcdData_Y1Followup_C4_filtered$bis_y_ss_bas_fs_plus1 <- abcdData_Y1Followup_C4_filtered$bis_y_ss_bas_fs + 1
abcdData_Y1Followup_C4_filtered$resiliency5a_y_plus1 <- abcdData_Y1Followup_C4_filtered$resiliency5a_y + 1
abcdData_Y1Followup_C4_filtered$resiliency6a_y_plus1 <- abcdData_Y1Followup_C4_filtered$resiliency6a_y + 1
abcdData_Y1Followup_C4_filtered$resiliency5b_y_plus1 <- abcdData_Y1Followup_C4_filtered$resiliency5b_y + 1
abcdData_Y1Followup_C4_filtered$resiliency6b_y_plus1 <- abcdData_Y1Followup_C4_filtered$resiliency6b_y + 1
abcdData_Y1Followup_C4_filtered$fes_p_ss_fc_pr_plus1 <- abcdData_Y1Followup_C4_filtered$fes_p_ss_fc_pr + 1
abcdData_Y1Followup_C4_filtered$psb_p_ss_mean_plus1 <- abcdData_Y1Followup_C4_filtered$psb_p_ss_mean + 1
abcdData_Y1Followup_C4_filtered$fes_y_ss_fc_pr_plus1 <- abcdData_Y1Followup_C4_filtered$fes_y_ss_fc_pr + 1
abcdData_Y1Followup_C4_filtered$psb_y_ss_mean_plus1 <- abcdData_Y1Followup_C4_filtered$psb_y_ss_mean + 1
abcdData_Y1Followup_C4_filtered$srpf_y_ss_iiss_plus1 <- abcdData_Y1Followup_C4_filtered$srpf_y_ss_iiss + 1
abcdData_Y1Followup_C4_filtered$stq_y_ss_weekday_plus1 <- abcdData_Y1Followup_C4_filtered$stq_y_ss_weekday + 1
abcdData_Y1Followup_C4_filtered$stq_y_ss_weekend_plus1 <- abcdData_Y1Followup_C4_filtered$stq_y_ss_weekend + 1
```

## Update labels #
```{r}
abcdData_Y1Followup_C4_filtered$ethnicity <- as.factor(abcdData_Y1Followup_C4_filtered$ethnicity)
levels(abcdData_Y1Followup_C4_filtered$ethnicity)
levels(abcdData_Y1Followup_C4_filtered$ethnicity) <- list (Latinx = "AMR", EUR = "EUR", AFR = "AFR")
levels(abcdData_Y1Followup_C4_filtered$ethnicity)
```

## Group by ancestry and sex #
```{r}
afr <- filter(abcdData_Y1Followup_C4_filtered, ethnicity == "AFR")
latinx <- filter(abcdData_Y1Followup_C4_filtered, ethnicity == "Latinx")
eur <- filter(abcdData_Y1Followup_C4_filtered, ethnicity == "EUR")

male <- filter(abcdData_Y1Followup_C4_filtered, sex == "M")
female <- filter(abcdData_Y1Followup_C4_filtered, sex == "F")
```

## Rename phenotypes for PheWAS plotting #
```{r}
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'bis_y_ss_bas_rr_plus1'] <- 'bis_y_ss_bas_rr'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'bis_y_ss_bas_drive_plus1'] <- 'bis_y_ss_bas_drive'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'pgbi_p_ss_score_plus1'] <- 'pgbi_p_ss_score'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_4b_p_plus1'] <- 'medhx_ss_4b_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_5b_p_plus1'] <- 'medhx_ss_5b_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6a_times_p_plus1'] <- 'medhx_ss_6a_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6b_times_p_plus1'] <- 'medhx_ss_6b_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6c_times_p_plus1'] <- 'medhx_ss_6c_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6d_times_p_plus1'] <- 'medhx_ss_6d_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6e_times_p_plus1'] <- 'medhx_ss_6e_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6f_times_p_plus1'] <- 'medhx_ss_6f_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6g_times_p_plus1'] <- 'medhx_ss_6g_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6h_times_p_plus1'] <- 'medhx_ss_6h_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6i_times_p_plus1'] <- 'medhx_ss_6i_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6j_times_p_plus1'] <- 'medhx_ss_6j_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6k_times_p_plus1'] <- 'medhx_ss_6k_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6l_times_p_plus1'] <- 'medhx_ss_6l_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6m_times_p_plus1'] <- 'medhx_ss_6m_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6n_times_p_plus1'] <- 'medhx_ss_6n_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6o_times_p_plus1'] <- 'medhx_ss_6o_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6p_times_p_plus1'] <- 'medhx_ss_6p_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6q_times_p_plus1'] <- 'medhx_ss_6q_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6r_times_p_plus1'] <- 'medhx_ss_6r_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_6s_times_p_plus1'] <- 'medhx_ss_6s_times_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'medhx_ss_9b_p_plus1'] <- 'medhx_ss_9b_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'devhx_16_p_plus1'] <- 'devhx_16_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'bis_y_ss_basm_rr_plus1'] <- 'bis_y_ss_basm_rr'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'bis_y_ss_basm_drive_plus1'] <- 'bis_y_ss_basm_drive'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'bis_y_ss_bas_fs_plus1'] <- 'bis_y_ss_bas_fs'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'resiliency5a_y_plus1'] <- 'resiliency5a_y_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'resiliency6a_y_plus1'] <- 'resiliency6a_y_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'resiliency5b_y_plus1'] <- 'resiliency5b_y_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'resiliency6b_y_plus1'] <- 'resiliency6b_y_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'fes_p_ss_fc_pr_plus1'] <- 'fes_p_ss_fc_pr_p'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'psb_p_ss_mean_plus1'] <- 'psb_p_ss_mean'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'fes_y_ss_fc_pr_plus1'] <- 'fes_y_ss_fc_pr'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'psb_y_ss_mean_plus1'] <- 'psb_y_ss_mean'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'srpf_y_ss_iiss_plus1'] <- 'srpf_y_ss_iiss'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'stq_y_ss_weekday_plus1'] <- 'stq_y_ss_weekday'
names(abcdData_Y1Followup_C4_filtered)[names(abcdData_Y1Followup_C4_filtered) == 'stq_y_ss_weekend_plus1'] <- 'stq_y_ss_weekend'
...
datalist <- list(abcdData_Y1Followup_C4_filtered)
names(datalist) <- c("abcdData_Y1Followup_C4_filtered")

# Linear model
for (j in 1:length(datalist)) {
df.linear <- data.frame() 
  for (i in c(72, 2503:2505)) {
...
# Gamma log-link
df.gamma <- data.frame() 
  for (i in c(10:16, 39, 41, 62:71, 73:81, 281:284, 286, 2560, 2591:2597)) { 
    this_var = datalist[[j]][, i]
...
df.logistic <- data.frame() 
    for (i in c(98, 101, 134:135, 137:138, 251, 261:262, 250, 252, 263:264)) {
    this_var = datalist[[j]][, i]
    my.model.0 <- glm(as.matrix(this_var) ~ c4b_expression + 
                        interview_age + ses_AvgIncomeParentEdu + pc1 + pc2 + pc3 + pc4 + sex + site_id_l, 
